...
function renderDescription(project) {
    ...
    const descriptionHTML = `
        ...
        <p>This ${project.category} project demonstrates innovative use of modern electronics and microcontroller technology. 
        ...
        <div class="col">
            <div class="card h-100 shadow-sm hover-card">
                <img src="${proj.imageUrl}" 
                     ...
                     onerror="this.src='https://placehold.co/400x300/23374D/FFFFFF?text=${encodeURIComponent(proj.category)}'">
                <div class="card-body d-flex flex-column">
                    <span class="badge bg-secondary mb-2 align-self-start">${proj.category}</span>
