...
**Purpose**: initialise a new pagination instance with configuration
...
**Purpose**: initialise the pagination - call this to begin!
...
2. Look for: `✓ Featured Projects initialised!`
